...
export const icons: Record<string, string> = {
  ...
  jira: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M11.53 2c0 2.4 1.97 4.35 4.35 4.35h1.78v1.7c0 2.4 1.94 4.34 4.34 4.35V2.84a.84.84 0 0 0-.84-.84H11.53zM6.77 6.8a4.362 4.362 0 0 0 4.34 4.34h1.8v1.72a4.362 4.362 0 0 0 4.34 4.34V7.63a.84.84 0 0 0-.84-.84H6.77zM2 11.6a4.362 4.362 0 0 0 4.34 4.34h1.8v1.72A4.362 4.362 0 0 0 12.48 22V12.43a.84.84 0 0 0-.84-.84H2z"/></svg>`,

  confluence: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M2.31 17.72c-.2.34-.43.72-.62 1.02a.87.87 0 0 0 .32 1.2l3.62 2.18a.87.87 0 0 0 1.18-.3c.17-.28.39-.64.64-1.05 1.77-2.95 3.5-2.58 6.71-1.05l3.48 1.66a.87.87 0 0 0 1.15-.44l1.77-3.87a.87.87 0 0 0-.42-1.14c-.87-.41-2.48-1.18-3.53-1.68-4.66-2.22-8.6-2.54-14.3 3.47zM21.69 6.28c.2-.34.43-.72.62-1.02a.87.87 0 0 0-.32-1.2L18.37 1.88a.87.87 0 0 0-1.18.3c-.17.28-.39.64-.64 1.05-1.77 2.95-3.5 2.58-6.71 1.05L6.36 2.62a.87.87 0 0 0-1.15.44L3.44 6.93a.87.87 0 0 0 .42 1.14c.87.41 2.48 1.18 3.53 1.68 4.66 2.22 8.6 2.54 14.3-3.47z"/></svg>`,
  ...
  mcp: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="8" rx="2"/><rect x="2" y="14" width="20" height="8" rx="2"/><circle cx="6" cy="6" r="1" fill="currentColor"/><circle cx="6" cy="18" r="1" fill="currentColor"/><line x1="10" y1="6" x2="18" y2="6"/><line x1="10" y1="18" x2="18" y2="18"/></svg>`,

  notifications: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>`,
  ...
  'source-control': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="6" cy="18" r="3"/><circle cx="6" cy="6" r="3"/><circle cx="18" cy="6" r="3"/><path d="M6 9v6"/><path d="M18 9a9 9 0 0 1-9 9"/></svg>`,
};
